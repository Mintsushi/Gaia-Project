...
import com.example.round.gaia_18.Callendar.cal.OneMonthView;
...
public class MonthlyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.cal_fragment_monthly, container, false);
        vvPager = (VerticalViewPager) v.findViewById(R.id.vvviewPager);
    ...
    private class MonthlySlidePagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Log.i("howFarFromBase : ", ""+howFarFromBase);
            Calendar cal = (Calendar) BASE_CAL.clone();
            cal.add(Calendar.MONTH, howFarFromBase);
            Log.i("howFarFromBase : ", ""+position+ " & "+PAGES);
