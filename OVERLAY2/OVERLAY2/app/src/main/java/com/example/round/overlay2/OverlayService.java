...
/**
 * Created by Round on 2017-05-27.
 */
...
//    }
    ...
    public void addView(ImageView imageButton){

        for(int i =0; i<mArray.size(); i++){
            if(mArray.get(i).getId() == imageButton.getId())
                return;
        }

        int [] location = new int[2];
        imageButton.getLocationOnScreen(location);
        ImageView overlayButton = new ImageView(this);
        overlayButton.setImageResource((Integer)imageButton.getTag());
        WindowManager.LayoutParams params = new WindowManager.LayoutParams(imageButton.getWidth(), imageButton.getHeight(), WindowManager.LayoutParams.TYPE_TOAST, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL, PixelFormat.TRANSLUCENT);
        params.gravity = Gravity.LEFT|Gravity.TOP;
        params.x = location[0];
        params.y = location[1];

        mArray.add(new PlantInfo(params,overlayButton,imageButton.getId()));
    ...
    public void onLongClick(final ImageView imageButton){
        Log.i(TAG,"************1  "+imageButton.getId());
        int [] location = new int[2];
        imageButton.getLocationOnScreen(location);
        final ImageView overlayButton = new ImageView(this);
        overlayButton.setImageResource((Integer)imageButton.getTag());
        final WindowManager.LayoutParams params = new WindowManager.LayoutParams(imageButton.getWidth(), imageButton.getHeight(), WindowManager.LayoutParams.TYPE_TOAST, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL, PixelFormat.TRANSLUCENT);
        params.gravity = Gravity.LEFT|Gravity.TOP;
        params.x = location[0];
        params.y = location[1];
